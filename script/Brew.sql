...
BEGIN
    SET NOCOUNT ON;
    DECLARE @SoCuoi INT;
    SELECT @SoCuoi = ISNULL(MAX(TRY_CAST(SUBSTRING(tableId, 3, LEN(tableId)) AS INT)), 0)
    FROM CafeTable;

    INSERT INTO CafeTable (tableId, floor, capacity, status)
    SELECT
        'TA' + RIGHT('00000' + CAST(ROW_NUMBER() OVER (ORDER BY (SELECT NULL)) + @SoCuoi AS VARCHAR(5)), 5),
...
VALUES
(GETDATE(), GETDATE(), DATEADD(HOUR, 1, GETDATE()), '0905123456', 120000, 120000, N'Đã thanh toán', 'KH00001', 'NV00004', 'TA00001'),
(DATEADD(DAY, -1, GETDATE()), DATEADD(DAY, -1, GETDATE()), DATEADD(HOUR, 1, DATEADD(DAY, -1, GETDATE())), '0905234567', 95000, 95000, N'Đã thanh toán', 'KH00002', 'NV00005', 'TA00002'),
(DATEADD(DAY, -5, GETDATE()), DATEADD(DAY, -5, GETDATE()), DATEADD(HOUR, 1, DATEADD(DAY, -5, GETDATE())), '0905345678', 185000, 185000, N'Đã thanh toán', 'KH00003', 'NV00003', 'TA00003'),
(DATEADD(MONTH, -1, GETDATE()), DATEADD(MONTH, -1, GETDATE()), DATEADD(HOUR, 2, DATEADD(MONTH, -1, GETDATE())), '0905456789', 275000, 275000, N'Đã thanh toán', 'KH00004', 'NV00002', 'TA00004'),
(DATEADD(MONTH, -2, GETDATE()), DATEADD(MONTH, -2, GETDATE()), DATEADD(HOUR, 1, DATEADD(MONTH, -2, GETDATE())), '0905567890', 210000, 210000, N'Đã thanh toán', 'KH00005', 'NV00005', 'TA00005');

INSERT INTO Bill (dateCreated, hourIn, hourOut, phoneNumber, total, custPayment, status, customerId, employeeId, tableId)
VALUES
('2023-01-10', '2023-01-10 08:30', '2023-01-10 09:15', '0909123456', 95000, 95000, N'Ðã thanh toán', 'KH00001', 'NV00001', 'TA00001'),
('2023-02-14', '2023-02-14 14:00', '2023-02-14 15:10', '0909345678', 120000, 120000, N'Ðã thanh toán', 'KH00002', 'NV00002', 'TA00002'),
('2023-03-05', '2023-03-05 09:45', '2023-03-05 10:30', '0909567890', 185000, 185000, N'Ðã thanh toán', 'KH00003', 'NV00003', 'TA00003'),
('2023-04-18', '2023-04-18 07:50', '2023-04-18 08:45', '0909789012', 220000, 220000, N'Ðã thanh toán', 'KH00004', 'NV00004', 'TA00004'),
('2023-05-25', '2023-05-25 13:10', '2023-05-25 14:20', '0909123987', 265000, 265000, N'Ðã thanh toán', 'KH00005', 'NV00005', 'TA00005'),
('2023-06-03', '2023-06-03 10:05', '2023-06-03 11:00', '0909789001', 145000, 145000, N'Ðã thanh toán', 'KH00006', 'NV00001', 'TA00001'),
('2023-07-22', '2023-07-22 16:30', '2023-07-22 17:25', '0909345111', 200000, 200000, N'Ðã thanh toán', 'KH00007', 'NV00002', 'TA00002'),
('2023-09-10', '2023-09-10 08:45', '2023-09-10 09:40', '0909789009', 300000, 300000, N'Ðã thanh toán', 'KH00008', 'NV00003', 'TA00003'),
('2023-11-15', '2023-11-15 07:30', '2023-11-15 08:10', '0909678008', 90000, 90000, N'Ðã thanh toán', 'KH00009', 'NV00004', 'TA00004'),
('2023-12-20', '2023-12-20 18:00', '2023-12-20 19:20', '0909123123', 180000, 180000, N'Ðã thanh toán', 'KH00010', 'NV00005', 'TA00005'),

('2024-01-08', '2024-01-08 09:00', '2024-01-08 10:15', '0909345999', 155000, 155000, N'Ðã thanh toán', 'KH00001', 'NV00001', 'TA00001'),
('2024-03-10', '2024-03-10 14:30', '2024-03-10 15:25', '0909678123', 250000, 250000, N'Ðã thanh toán', 'KH00002', 'NV00002', 'TA00002'),
('2024-04-25', '2024-04-25 10:10', '2024-04-25 11:05', '0909345333', 175000, 175000, N'Ðã thanh toán', 'KH00003', 'NV00003', 'TA00003'),
('2024-05-12', '2024-05-12 07:55', '2024-05-12 08:45', '0909789111', 195000, 195000, N'Ðã thanh toán', 'KH00004', 'NV00004', 'TA00004'),
('2024-06-18', '2024-06-18 09:15', '2024-06-18 10:30', '0909123888', 285000, 285000, N'Ðã thanh toán', 'KH00005', 'NV00005', 'TA00005'),
('2024-08-07', '2024-08-07 16:00', '2024-08-07 17:10', '0909789222', 130000, 130000, N'Ðã thanh toán', 'KH00006', 'NV00001', 'TA00001'),
('2024-09-21', '2024-09-21 08:30', '2024-09-21 09:20', '0909567222', 100000, 100000, N'Ðã thanh toán', 'KH00007', 'NV00002', 'TA00002'),
('2024-10-30', '2024-10-30 13:00', '2024-10-30 14:10', '0909345444', 230000, 230000, N'Ðã thanh toán', 'KH00008', 'NV00003', 'TA00003'),

('2025-01-03', '2025-01-03 08:45', '2025-01-03 09:30', '0909789555', 165000, 165000, N'Ðã thanh toán', 'KH00009', 'NV00004', 'TA00004'),
('2025-02-11', '2025-02-11 17:15', '2025-02-11 18:05', '0909345666', 200000, 200000, N'Ðã thanh toán', 'KH00010', 'NV00005', 'TA00005'),
('2025-03-19', '2025-03-19 10:05', '2025-03-19 11:00', '0909123999', 270000, 270000, N'Ðã thanh toán', 'KH00001', 'NV00001', 'TA00001'),
('2025-06-08', '2025-06-08 08:15', '2025-06-08 09:05', '0909789777', 85000, 85000, N'Ðã thanh toán', 'KH00002', 'NV00002', 'TA00002'),
('2025-08-27', '2025-08-27 15:00', '2025-08-27 15:50', '0909678333', 150000, 150000, N'Ðã thanh toán', 'KH00003', 'NV00003', 'TA00003'),
('2025-10-12', '2025-10-12 07:45', '2025-10-12 08:30', '0909345777', 280000, 280000, N'Ðã thanh toán', 'KH00004', 'NV00004', 'TA00004');
...
VALUES
-- Năm 2023
('2023-01-15', '2023-01-15 08:30', '2023-01-15 09:20', '0903000001', 150000, 150000, N'Đã thanh toán', 'KH00001', 'NV00001', 'TA00001'),
('2023-02-20', '2023-02-20 09:00', '2023-02-20 09:45', '0903000002', 180000, 180000, N'Đã thanh toán', 'KH00002', 'NV00002', 'TA00002'),
('2023-03-12', '2023-03-12 14:00', '2023-03-12 15:00', '0903000003', 210000, 210000, N'Đã thanh toán', 'KH00003', 'NV00003', 'TA00003'),
('2023-04-18', '2023-04-18 10:00', '2023-04-18 10:50', '0903000004', 170000, 170000, N'Đã thanh toán', 'KH00004', 'NV00004', 'TA00004'),
('2023-05-22', '2023-05-22 08:30', '2023-05-22 09:15', '0903000005', 190000, 190000, N'Đã thanh toán', 'KH00005', 'NV00005', 'TA00005'),
('2023-06-10', '2023-06-10 16:00', '2023-06-10 17:00', '0903000006', 200000, 200000, N'Đã thanh toán', 'KH00006', 'NV00001', 'TA00001'),
('2023-07-08', '2023-07-08 08:45', '2023-07-08 09:30', '0903000007', 230000, 230000, N'Đã thanh toán', 'KH00007', 'NV00002', 'TA00002'),
('2023-08-19', '2023-08-19 15:00', '2023-08-19 16:00', '0903000008', 260000, 260000, N'Đã thanh toán', 'KH00008', 'NV00003', 'TA00003'),
('2023-09-25', '2023-09-25 09:10', '2023-09-25 10:00', '0903000009', 185000, 185000, N'Đã thanh toán', 'KH00009', 'NV00004', 'TA00004'),
('2023-10-05', '2023-10-05 07:45', '2023-10-05 08:30', '0903000010', 175000, 175000, N'Đã thanh toán', 'KH00010', 'NV00005', 'TA00005'),
('2023-11-14', '2023-11-14 17:00', '2023-11-14 17:45', '0903000011', 155000, 155000, N'Đã thanh toán', 'KH00001', 'NV00001', 'TA00001'),
('2023-12-22', '2023-12-22 13:00', '2023-12-22 14:00', '0903000012', 220000, 220000, N'Đã thanh toán', 'KH00002', 'NV00002', 'TA00002'),

-- Năm 2024
('2024-01-12', '2024-01-12 08:00', '2024-01-12 09:00', '0904000001', 180000, 180000, N'Đã thanh toán', 'KH00003', 'NV00003', 'TA00003'),
('2024-02-19', '2024-02-19 14:00', '2024-02-19 15:00', '0904000002', 190000, 190000, N'Đã thanh toán', 'KH00004', 'NV00004', 'TA00004'),
('2024-03-25', '2024-03-25 07:30', '2024-03-25 08:15', '0904000003', 210000, 210000, N'Đã thanh toán', 'KH00005', 'NV00005', 'TA00005'),
('2024-04-15', '2024-04-15 09:00', '2024-04-15 10:00', '0904000004', 165000, 165000, N'Đã thanh toán', 'KH00006', 'NV00001', 'TA00001'),
('2024-05-08', '2024-05-08 10:30', '2024-05-08 11:20', '0904000005', 195000, 195000, N'Đã thanh toán', 'KH00007', 'NV00002', 'TA00002'),
('2024-06-24', '2024-06-24 08:10', '2024-06-24 09:00', '0904000006', 250000, 250000, N'Đã thanh toán', 'KH00008', 'NV00003', 'TA00003'),
('2024-07-30', '2024-07-30 16:00', '2024-07-30 16:45', '0904000007', 230000, 230000, N'Đã thanh toán', 'KH00009', 'NV00004', 'TA00004'),
('2024-08-18', '2024-08-18 07:40', '2024-08-18 08:25', '0904000008', 200000, 200000, N'Đã thanh toán', 'KH00010', 'NV00005', 'TA00005'),
('2024-09-14', '2024-09-14 11:00', '2024-09-14 11:45', '0904000009', 185000, 185000, N'Đã thanh toán', 'KH00001', 'NV00001', 'TA00001'),
('2024-10-22', '2024-10-22 13:10', '2024-10-22 14:00', '0904000010', 210000, 210000, N'Đã thanh toán', 'KH00002', 'NV00002', 'TA00002'),
('2024-11-09', '2024-11-09 09:00', '2024-11-09 09:50', '0904000011', 240000, 240000, N'Đã thanh toán', 'KH00003', 'NV00003', 'TA00003'),
('2024-12-27', '2024-12-27 15:00', '2024-12-27 15:50', '0904000012', 280000, 280000, N'Đã thanh toán', 'KH00004', 'NV00004', 'TA00004'),

-- Năm 2025
('2025-01-11', '2025-01-11 08:30', '2025-01-11 09:20', '0905000001', 150000, 150000, N'Đã thanh toán', 'KH00005', 'NV00005', 'TA00005'),
('2025-02-16', '2025-02-16 14:00', '2025-02-16 14:45', '0905000002', 175000, 175000, N'Đã thanh toán', 'KH00006', 'NV00001', 'TA00001'),
('2025-03-10', '2025-03-10 10:00', '2025-03-10 10:50', '0905000003', 190000, 190000, N'Đã thanh toán', 'KH00007', 'NV00002', 'TA00002'),
('2025-04-22', '2025-04-22 07:30', '2025-04-22 08:20', '0905000004', 200000, 200000, N'Đã thanh toán', 'KH00008', 'NV00003', 'TA00003'),
('2025-05-13', '2025-05-13 15:00', '2025-05-13 15:50', '0905000005', 225000, 225000, N'Đã thanh toán', 'KH00009', 'NV00004', 'TA00004'),
('2025-06-17', '2025-06-17 09:15', '2025-06-17 10:00', '0905000006', 260000, 260000, N'Đã thanh toán', 'KH00010', 'NV00005', 'TA00005'),
('2025-07-23', '2025-07-23 08:45', '2025-07-23 09:30', '0905000007', 195000, 195000, N'Đã thanh toán', 'KH00001', 'NV00001', 'TA00001'),
('2025-08-14', '2025-08-14 13:00', '2025-08-14 13:50', '0905000008', 180000, 180000, N'Đã thanh toán', 'KH00002', 'NV00002', 'TA00002'),
('2025-09-20', '2025-09-20 17:00', '2025-09-20 17:45', '0905000009', 220000, 220000, N'Đã thanh toán', 'KH00003', 'NV00003', 'TA00003'),
('2025-10-29', '2025-10-29 07:45', '2025-10-29 08:35', '0905000010', 240000, 240000, N'Đã thanh toán', 'KH00004', 'NV00004', 'TA00004'),
('2025-11-18', '2025-11-18 10:30', '2025-11-18 11:20', '0905000011', 210000, 210000, N'Đã thanh toán', 'KH00005', 'NV00005', 'TA00005'),
